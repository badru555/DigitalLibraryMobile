...
public class ilmukesehatan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ilmukesehatan);
        ...
        String fakultas = "kesehatan";
        pdfDocuments = new JSONDownloader(ilmukesehatan.this,fakultas).retrieve(myGridView, myProgressBar);
