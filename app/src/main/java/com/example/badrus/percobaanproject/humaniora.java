...
public class humaniora extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humaniora);
        ...
        String fakultas = "humaniora";
        pdfDocuments = new JSONDownloader(humaniora.this,fakultas).retrieve(myGridView, myProgressBar);
