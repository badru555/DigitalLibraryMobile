...
public class syariah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syariah);
        ...
        String fakultas = "syariah";
        pdfDocuments = new JSONDownloader(syariah.this,fakultas).retrieve(myGridView, myProgressBar);
